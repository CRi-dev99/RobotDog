...
class Control:
    def __init__(self):
        ...
        self.calibration_point = self.readFromTxt(os.path.join(base_path, 'point'))
    ...
    def readFromTxt(self,filename):
        ...
        try:
            ...
            print(f"Warning: calibration file not found: {path}. Using default calibration points.")
            return [[13, 77, -12], [-11, 90, -15], [5, 91, 1], [2, 95, -12]]
